...
<div class="container mx-auto mt-6">
    ...
    <div
        ...
        <div class="flex flex-col justify-between p-6 leading-normal w-full">
            <h5 class="mb-2 text-xl font-bold tracking-tight text-black-600 dark:text-white"><u>Submit Labwork:</u></h5>

            <form action="{{ route('uploadLabwork', ['labwork_id' => $labwork->id]) }}" method="POST"
