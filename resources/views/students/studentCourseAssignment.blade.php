...
<div class="container mx-auto mt-6">
    ...
    <div
        ...
        <div class="flex flex-col justify-between p-6 leading-normal w-full">
            ...
            <h1 class="mb-2 text-4xl font-bold tracking-tight text-black-600 dark:text-white">Assignments</h1>
        </div>
    </div>
            ...
            <tbody>
                @foreach($assignments as $index => $assignment)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('gotoStudentSubmitAssignment', ['assignment_id' => $assignment->id])}}"
